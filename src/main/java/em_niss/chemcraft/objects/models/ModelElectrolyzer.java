...
public class ModelElectrolyzer implements IDynamicBakedModel
{
	public static final ResourceLocation TEXTURE = new ResourceLocation(Chemcraft.MODID, "block/block_electrolyzer");
	...
	private static Vec3d v(double x, double y, double z) { return new Vec3d(x, y, z); }
